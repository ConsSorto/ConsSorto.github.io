---
layout: default
title: "Clase 3: Setup Backend (.NET) y Clean Architecture en el Monorepo"
...
graph TD
    subgraph CapaExterna [Capa Externa - Detalles]
    ...
    subgraph CapaInterna [Capa Interna - Core]
