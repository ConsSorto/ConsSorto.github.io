...
**2. Configuración en la API (`/backend/HabitForge.API`):**
...
**3. La Entidad de Dominio (`backend/HabitForge.Domain/Entities/HabitoGlobal.cs`):**
...
**4. El Contexto de Base de Datos (`backend/HabitForge.Infrastructure/Data/HabitForgeDbContext.cs`):**
