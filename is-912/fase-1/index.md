...
**[3. Setup Backend (.NET) y Clean Architecture en el Monorepo](./3.md)**
Creación del proyecto estructurado por capas: Core/Domain, Application, Infrastructure, y Web/API.

**[4. Base de Datos con Docker, ORM y Variables de Entorno (12-Factor App)](./4.md)**
Conexión de BD mediante C# (Code-First) y aislamiento del ORM en Infraestructura.

**[5. Casos de Uso, Controladores y el Patrón Repositorio](./5.md)**
...
**[7. Pruebas de API y Documentación (Swagger)](./7.md)**
Uso de Swagger/OpenAPI para documentar y probar endpoints.

**[8. Evolución a Vertical Slicing](./8.md)**
