...
**Problemas o Soluciones:** Identifica qué ideas tienes o qué problemas detectaste.
**Usuarios y Clientes:** Define específicamente para quién estamos construyendo (no es para "todos").
**Soluciones Hoy:** ¿Cómo sobrevive el usuario actualmente? (competencia o procesos manuales).
**Valor para el Usuario:** ¿Qué podrá hacer el usuario de forma diferente una vez que tenga el sistema?.
**Métricas de Usuario:** ¿Qué comportamientos podemos medir para saber si lo están usando?.
**Estrategia de Adopción:** ¿Cómo van a descubrir los usuarios esta nueva funcionalidad?.
**Problema de Negocio:** ¿Qué problema le resuelve a nuestra empresa construir esto?.
**Métricas de Negocio:** ¿Cómo se verá reflejado el éxito en los ingresos o la eficiencia de la Empresa?.
**Presupuesto:** ¿Cuánto dinero o tiempo estamos dispuestos a invertir en descubrir y construir esto?.
